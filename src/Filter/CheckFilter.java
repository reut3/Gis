...
public class CheckFilter {
	...
	public static void WhichOP(String s,DataBase database)
	{
		...
		case "And":
			...
			{
				database.FinalFilterDatabase=Filter.filter.filterAnd(database.FinalDataBase, Filter.filter.equalId(WhatShouldIdo[2],WhatShouldIdo[3]), Filter.filter.equalTime(WhatShouldIdo[5], WhatShouldIdo[6],WhatShouldIdo[7]));				
			}
