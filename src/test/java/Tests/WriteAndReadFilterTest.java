...
public class WriteAndReadFilterTest {

	String s="one,ID,1,inon";
	String fileName="reut";
	...
	public void testWriteAndRead() {
		Filter.WriteAndReadFilter.writefilter(fileName, s);
		//String path="savedFilters\\";"
		Filter.WriteAndReadFilter.Readfilter("testFile\\filtertestfile\\reut.txt", Datbase);
		assertTrue(Datbase.FinalFilterDatabase.size()==5);
